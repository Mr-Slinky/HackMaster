...
public interface Cell {
     ...
     *
     * @param listener the listener to be added, which should implement the
     * {@code ChangeListener<? super Boolean>} interface. This listener will be
     * notified with the new value whenever the `clickCount` changes.
     */
    void addClickListener(ChangeListener<? super Boolean> listener);
    ...
    /**
     * Handles the internal behaviour triggered by a click on this cell. This
     * typically involves delegating the click to any main cluster. The exact
     * behavior may vary depending on the implementation specifics.
     */
    void click();
